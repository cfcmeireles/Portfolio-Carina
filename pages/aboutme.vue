  ...
  <body class="bg-darkblue">
    <main class="h-screen flex items-center justify-center">
      <div class="m-20">
        ...
        <div
          class="flex flex-col lg:grid"
          style="grid-template-columns: 700px 700px"
        >
          <div>
            <h2 class="text-2xl my-5 text-white">
              Hi, I'm <strong>Carina</strong>
            </h2>
            <p class="leading-normal font-rubik">
          ...
          <div>
            <h2 class="text-2xl my-5 text-white">What is my skill level?</h2>
            <p class="leading-normal font-rubik">
        ...
        <h3 class="text-2xl my-5 text-white">My current tech stack:</h3>
        <div
